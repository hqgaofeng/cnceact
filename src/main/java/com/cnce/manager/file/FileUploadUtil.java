...
public class FileUploadUtil {
    ...
    private String url = JenkinsConstant.SERVER_IP;

    private String passWord = JenkinsConstant.LOGIN_PASSWORD;

    private String userName = JenkinsConstant.LOGIN_USERNAME;
