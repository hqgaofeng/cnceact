var prefix = "/manager/heartbeatAndPretestTools"
        ...
        success: function (data) {
            if (data) {
                ...
                var sitv = setInterval(function () {
                    var prog_url = "/manager/progreBar/load?toolId=6&timestamp="+timestamp;  //获取进度的请求url
                ...
                layer.confirm("确认要执行的'" + rows.length + "'条用例吗?", {
                    btn : [ '确定', '取消' ]
                    // 按钮
                },function () {
